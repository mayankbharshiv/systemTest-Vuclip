...
public class DateTimeUtil {
    ...
    public static String getTime(String yyyy,String mm,String dd , String HH, String MM, String SS) {

      /*  LocalDateTime localDateTime = LocalDateTime.parse(yyyy + "-" + mm + "-" + dd + HH + ":" + MM + ":" + SS,
                DateTimeFormatter.ofPattern("yyyy-MM-ddHH:mm:ss"));*/
        
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-ddHH:mm:ss");
        LocalDateTime dateTime = LocalDateTime.parse(yyyy + "-" + mm + "-" + dd + HH + ":" + MM + ":" + SS);
