...
@JsonPropertyOrder({ "billingCode", "price", "description", "validity", "noOfCredits", "serviceId", "appId", "ujId",
		...
		"productId", "partnerId", "countryCode", "actInitValidity", "deactivationRetryValidity",
		"notificationWaitPeriod", "timeUnit" })
public class PublishPricePoint {
	 ...
	 */
	public PublishPricePoint(String billingCode, Double price, String description, Integer validity, Integer noOfCredits,
			Integer serviceId, Integer appId, Integer ujId, Integer itemId, Integer itemTypeId,
			Boolean balanceCheckRequired, Boolean fallbackApplicable, Boolean freeTrialApplicable,
			String fallbackPpBillingCode, String freeTrialBillingCode, Integer freeTrialDays, Integer exclusionPeriod,
			Boolean autoRenewalApplicable, String status, Boolean contentAccessPostDeactivation,
			Integer noOfDaysContentAccessAllowInParking, Integer noOfDaysContentAccessAllowInSuspend,
			Integer parkingPeriod, Integer suspendPeriod, Integer activationCoolDownPeriod, Integer productId,
			Integer partnerId, String countryCode, Integer actInitValidity, Integer deactivationRetryValidity,
			Integer notificationWaitPeriod, String timeUnit) {
		super();
