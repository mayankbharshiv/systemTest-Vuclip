...
* @param retryable
* @param executingDays
* @param actionDefaultEiligible
* @param typeOfCycle
* @param activityType
*/
public Retry(Integer retryId, Integer productId, Integer partnerId, String countryCode, String operationType, String activityType, Integer maxRetryCount, Integer retryIntervalInMinutes, String attemptWindow, String typeOfCycle, Integer batchSize, Integer schedulingFrequencyInMinutes, String schedulingDays, String executingTimeWindow, String executingDays, String status, Boolean actionDefaultEiligible, Boolean retryable) {
super();
