...
public class ActivityType {
    ...
    public final static String ACTIVATION_TYPE = "ACTIVATION";
    public final static String ENGAGEMENT_SMS_TYPE = "ENGAGEMENT_SMS";
    public final static String OPTOUT_SMS_TYPE = "OPTOUT_SMS";
    ...
    public final static String SYSTEM_CHURN_TYPE = "SYSTEM_CHURN";
    public final static String CONTENT_SMS_TYPE = "CONTENT_SMS";
    public final static String PRE_RENEWAL_SMS_TYPE = "PRE_RENEWAL_SMS";
}
