...
* @param dateFormat
* @param blacklistApplicable
*/
public ProductPartnerMapping(Integer productId, Integer partnerId, Boolean chargingDependOnSmsDelivery, Boolean optOutSmsEnabled, Boolean preRenewalSmsEnabled, String partnerConsentParserEndpoint, String partnerConsentUrlGenerationEndpoint, String dateFormat, String operationType, Boolean blacklistApplicable, Boolean validityFromPartner, Integer blacklistValidity, Boolean cooldownApplicable, Integer cooldownValidity, String timeUnit, Boolean stepUpChargingApplicable, Integer allowedFreeTrialCount) {
super();
