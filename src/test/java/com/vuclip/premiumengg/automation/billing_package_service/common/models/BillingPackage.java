...
public class BillingPackage {
    ...
    public static BillingPackage PACKAGE1;
    public static BillingPackage PACKAGE2;

//	PACKAGE1(999, "TestProduct999", 999, "TestPartner999", "India", "IN", "927319999", "TEST_SERVICEID_927319999", 999.99,
//            "INR", 30, 7, 5, 1, "DAYS", 1, 1, 1, "ACTIVE", false, false, false, false),
...
//            "INR", 30, 7, 5, 1, "DAYS", 1, 1, 1, "ACTIVE", false, false, false, false);
    ...
    public BillingPackage(int productId, String productName, int partnerId, String partnerName, String country,
                          String countryCode, String billingCode, String serviceId, double price, String currency, int validityPeriod,
                          int parkingPeriod, int suspendPeriod, int notificationWaitPeriod, String timeUnit, int itemId,
                          int itemTypeId, int clientId, String status, boolean balanceCheckRequired, boolean carrier,
                          boolean freeTrial, boolean fallback) {
