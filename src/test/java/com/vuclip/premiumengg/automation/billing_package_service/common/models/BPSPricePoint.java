...
@JsonPropertyOrder({ "productId", "partnerId", "billingCode", "countryCode", "price", "description", "validity",
		"noOfCredits", "serviceId", "appId", "ujId", "itemId", "itemTypeId", "balanceCheckRequired",
		"fallbackApplicable", "freeTrialApplicable", "fallbackPpBillingCode", "freeTrialBillingCode", "freeTrialDays",
		"exclusionPeriod", "autoRenewalApplicable", "status", "contentAccessPostDeactivation",
		"noOfDaysContentAccessAllowInParking", "noOfDaysContentAccessAllowInSuspend", "parkingPeriod", "suspendPeriod",
		"activationCoolDownPeriod", "operationType", "actInitValidity", "deactivationRetryValidity",
