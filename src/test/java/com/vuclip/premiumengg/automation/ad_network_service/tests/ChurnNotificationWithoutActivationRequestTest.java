...
public class ChurnNotificationWithoutActivationRequestTest {

    @Test(groups = {"positive"})
    public void churnNotificationWithoutActivationRequestTest() throws Exception {
        Log4J.getLogger().info("===============================>Starting test case " + ChurnNotificationWithoutActivationRequestTest.class);
