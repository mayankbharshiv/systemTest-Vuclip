...
public class ANSValidationHelper {
	...
	public static void validateUserAdnotificationTable(int productId, int partnerId, String transactionID, String col,
		...
		try {
			...
			Thread.sleep(800);
			Map<String, Object> actualrecord = DBUtils.getRecord("user_adnotification", "transaction_id ='"
					+ transactionID + "' and product_id = " + productId + " and partner_id=" + partnerId).get(0);
