...
public class LowBalanceActivationTests {

    @Test(groups = {"positive"})
    public void lowBalanceActivationTests() throws Exception {
        Log4J.getLogger().info("===============================>Starting test case " + LowBalanceActivationTests.class);
