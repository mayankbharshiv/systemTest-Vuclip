...
public class PartnerDBHelper {
    ...
    public static void verifyNoActivityRecordPresent(String tableName, String partnerName) throws SQLException {

        AppAssert.assertTrue(DBUtils.getRecord(tableName, "partner_name =" + partnerName).size() == 0,
